...
async def on_split_contract_origination_a(
    ...
    if split_contract_a_origination.data.sender_address != 'KT1DoyD6kr8yLK8mRBFusyKYJUk2ZxNHKP1N':
        return
    if split_contract_a_origination.storage.tokenAddress != 'KT1RJ6PbjHpwc3M5rw5s2Nbmefwbuwbdxton':
        return
    if split_contract_a_origination.storage.minterAddress != 'KT1Hkg5qeNhfwpKW4fXvq7HGZB9z2EnmCCA9':
        return
